...
while len(urls) > 0 and len(opened) < maxNumUrl:
    ...
    try:
        ...
        req = urllib.request.Request(curr_url,headers={'User-Agent': 'Mozilla/5.0'}) #have to specify header 'User-Agent' otherwise will throw an error
    ...
    for tag in soup.find_all('a', href = True): #find tags with links
        ...
        o_childurl = childUrl
        childUrl = urllib.parse.urljoin(seed_url, childUrl)    #joining two urls
